  ...
  try {
    ...
    if (req?.body?.mobile !== "undefined") {
      ...
      const data = await User.find().select(
        "-_id -firstname -lastname -email -password -role -isBlocked -cart -address -wishlist -createdAt -updatedAt -__v -refreshToken -passwordResetExpire -passwordResetToken"
      );
