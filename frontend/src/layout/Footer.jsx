    ...
    <div className="container">
        <div className="footer-contain-section border-b border-ruby-gamma border-dashed pb-6 mb-8">
            <div className="furniture-rental mb-6">
                ...
                <p className="text-base leading-6 font-normal text-ruby-beta">Are you looking for a cost-effective and flexible way to furnish your home or office? Furniture rental may be the solution you have been searching for. CityFurnish, a leading furniture rental company, offers a wide range of home and office furniture for rent online, through their user-friendly furniture rental app.</p>
            </div>
...
<li className="mb-4">
<a href="https://zior.in/" className="text-base leading-6 font-normal text-ruby-beta hover:text-pearl-alpha" aria-label="Furniture Sale" rel="noopener">Furniture Sale</a>
</li>
</ul>
</div>
...
<ul className="flex items-center justify-between">
  <li>
    <a href="https://www.facebook.com/cityFurnishRental/" className="bg-no-repeat bg-contain w-8 h-8 inline-block" aria-label="Facebook" rel="noopener" style={{ backgroundImage: 'url(https://d3juy0zp6vqec8.cloudfront.net/images/facebook.svg)' }}></a>
  </li>
  <li>
    <a href="https://www.youtube.com/channel/UCPxgx4WxU86cbr38oqGu-OQ" className="bg-no-repeat bg-contain w-8 h-8 inline-block" aria-label="Youtube" rel="noopener" style={{ backgroundImage: 'url(https://d3juy0zp6vqec8.cloudfront.net/images/youtube.svg)' }}></a>
  </li>
  <li>
    <a href="https://www.instagram.com/cityfurnish/?hl=en" className="bg-no-repeat bg-contain w-8 h-8 inline-block" aria-label="Instagram" rel="noopener" style={{ backgroundImage: 'url(https://d3juy0zp6vqec8.cloudfront.net/images/instagram.svg)' }}></a>
  </li>
  <li>
    <a href="https://www.linkedin.com/company/cityfurnish/" className="bg-no-repeat bg-contain w-8 h-8 inline-block" aria-label="Linkedin" rel="noopener" style={{ backgroundImage: 'url(https://d3juy0zp6vqec8.cloudfront.net/images/linkedin.svg)' }}></a>
  </li>
  <li>
    <a href="https://twitter.com/CityFurnish" className="bg-no-repeat bg-contain w-8 h-8 inline-block" aria-label="Twitter" rel="noopener" style={{ backgroundImage: 'url(https://d3juy0zp6vqec8.cloudfront.net/images/twitter.svg)' }}></a>
  </li>
  <li>
    <a href="https://in.pinterest.com/cityfurnish/" className="bg-no-repeat bg-contain w-8 h-8 inline-block" aria-label="Pinterest" rel="noopener" style={{ backgroundImage: 'url(https://d3juy0zp6vqec8.cloudfront.net/images/pinterest.svg)' }}></a>
  </li>
</ul>
</li>
</ul>
