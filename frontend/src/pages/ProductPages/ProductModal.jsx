...
const ProductModal = () => {
    ...
    const productMoadalData = async () => {
        const data = await axios.get(`http://192.168.1.28:7001/api${location}`);
        setmodals(data.data);
    }
        ...
        <>
            <div className="page-wrapper ">
                ...
                <section className="product-detail-main">
                    ...
                    {modals.length!==0 && <div className="container" style={{ boxSizing: "border-box" }}>
                                ...
                                <div className="product-main-info  flex-full">
                                    ...
                                    <div className="product-actions flex-full justify-content-center text-center d-none-xs">
                                        <div className="product-btns flex-full justify-content-center text-center">
                                            <a href="#" className="addtocart product-btn" id="add-to-cart-btn" onClick="ajax_add_cart('4')">Add to Cart</a>
